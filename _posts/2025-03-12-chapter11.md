...
Angelo clapped his hands. “Alright, give it a shot! First, implement `length`, then `concatenate`. Just remember—don’t forget to allocate enough memory and always add a `0` at the end of your string.” 

Leo and Jasmina exchanged a determined look before diving into their code.
